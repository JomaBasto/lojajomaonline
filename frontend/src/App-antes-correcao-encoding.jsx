...
const newPromoPrice = prompt(
  "PreÃ§o promocional (deixe vazio se NÃ£o existir):",
  product.promoPrice || ""
);
...
console.log("TAMANHOS ESCOLHIDOS:", newSizes);
  ...
  alert("Erro ao definir PROMOÃ‡ÃƒO: " + erro);
  return;
}

    alert("PROMOÃ‡ÃƒO definida com sucesso!");
    ...
    <section id="ofertas" className="promocoes-container">
      <section className="seo-home">
        <div className="seo-home-container">
          ...
          <p>
            A <strong>JomaBasto Store</strong> Ã© revendedora oficial da <strong>Joma</strong> em Portugal,
            com <strong>sapatilhas, vestuÃ¡rio e acessÃ³rios</strong> para
...
<input
  type="number"
  placeholder="PreÃ§o PROMOÃ‡ÃƒO (opcional)"
...
>
  ...
  <option value="textil">TÃªxtil</option>
...
{isAdmin && (
  <div className="product-actions">
    ...
    <button onClick={() => setPromocao(p._id)}>
      {p.promocao ? "Remover PROMOÃ‡ÃƒO" : "PROMOÃ‡ÃƒO"}
    </button>
...
<button
  onClick={() => {
    const mensagem = `OlÃ¡, gostaria de saber se tÃªm disponÃ­vel o produto ${selectedProduct.name}.
${selectedProduct.reference ? `ReferÃªncia: ${selectedProduct.reference}` : ""}
...
<section className="faq-home">
  ...
  <div className="faq-item">
    <h3>Os produtos Joma sÃ£o originais?</h3>
    <p>
      Sim. A JomaBasto Store Ã© revendedora oficial da Joma em Portugal e
  ...
  <div className="faq-item">
    ...
    <p>
      As encomendas sÃ£o expedidas rapidamente atravÃ©s dos CTT, com entrega
      normalmente entre 3 e 5 dias Ãºteis em Portugal Continental.
    </p>
  </div>
  ...
  <div className="faq-item">
    ...
    <p>
      Sim. DispÃµe de atÃ© 15 dias para solicitar a troca ou devoluÃ§Ã£o, de
      acordo com a nossa polÃ­tica de trocas.
    </p>
  </div>

  <div className="faq-item">
    <h3>Os portes sÃ£o gratuitos?</h3>
    <p>
      Sim. Os portes sÃ£o gratuitos para encomendas superiores a 70 â‚¬.
    </p>
  </div>
...
<div className="footer-block">
  ...
  <div className="footer-bottom">
    <span>Copyright Â© {new Date().getFullYear()} JomaBasto â€” Todos os direitos reservados</span>

    <div className="footer-links">
      <a href="/quem-somos">Quem Somos</a>
      <a href="/condicoes-de-utilizacao">CondiÃ§Ãµes de utilizaÃ§Ã£o</a>
      <a href="/avisos-legais">Avisos Legais</a>
      <a href="/politica-de-privacidade">PolÃ­tica de Privacidade</a>
      <a href="/politica-de-cookies">PolÃ­tica de Cookies</a>
      <span className="footer-cookie-separator">|</span>
      <a href="/politica-de-cookies">Alterar as configuraÃ§Ãµes de cookies</a>
...
>
{orders.length === 0 ? (
  <p>Ainda NÃ£o existem encomendas.</p>
) : (
  orders.map((order)=>(
    <div
      key={order._id}
